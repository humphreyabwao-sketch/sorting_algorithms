...
/**
 * print_deck - Prints the content of a deck of cards.
...
/**
 * init_deck - Initializes a deck of cards with the provided cards array.
 * @cards: Array of cards to initialize the deck with.
...
{"2", SPADE}, {"2", DIAMOND}, {"King", CLUB}, {"Queen", SPADE},
{"Queen", DIAMOND}, {"7", CLUB}, {"7", HEART}, {"5", CLUB}, {"10", DIAMOND},
{"4", CLUB}, {"King", HEART}, {"Ace", HEART},
};
deck_node_t *deck;
