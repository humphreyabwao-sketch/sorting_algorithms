...
/**
* get_card_position - Get the position of a card.
* @node: The card node.
...
* @deck: The card deck.
* Return: A pointer to the card that was inserted.
*/
...
/**
* insertion_sort_deck - Sorts a deck of cards using insertion sort algorithm.
...
/**
* sort_deck - Sorts a deck of cards using insertion sort algorithm.
* @deck: The deck of cards to be sorted.
*/
